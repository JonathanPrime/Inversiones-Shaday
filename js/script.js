...
$('.owl-filter-class').on('click', '.item', function () {
  ...
  let previewContainer = document.querySelector('.detail-preview-container');
  let previewBox = previewContainer.querySelectorAll('.detail-preview');

  document.querySelectorAll('.detail .slide').forEach(detail => {
    detail.onclick = () => {
...
popupWhatsApp = () => {
  ...
  sendBtn.addEventListener("click", () => {
    ...
    window.open('https://wa.me/573103114139?text=' + relmsg, '_blank');
...
sendOrderBtn.addEventListener("click", () => {
  ...
  if (name == null || tel == null || dir == null
    ...
    window.open('https://wa.me/573103114139?text=' + relmsg + "%0a"
      + "---------------------------------" + "%0a"
      + "       DATOS DEL PEDIDO          " + "%0a"
      + "---------------------------------" + "%0a"
      + carritoEnTexto + "%0a"
